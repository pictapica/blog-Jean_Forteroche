  ...
  <body><div class="homepage-hero-module">
    <div class="video-container">
        ...
        <video autoplay loop class="fillWidth">
            <source src="../web/images/Snow_Wires.mp4" type="video/mp4" />Your browser does not support the video tag. I suggest you upgrade your browser.
            
        </video>
        <div class="title-container">
            <div class="headline">
               <img src="../web/images/jeanforteroche.png" height="130" alt="Jean Forteroche">
             
             <h3 class="text-white text-thin">Billet simple pour l'Alaska</h3>
             <h4 class="text-white text-thin">Decouvrez son prochain livre  chapitre par chapitre</h4> <br/>  
            <a href="index2.php" class="btn btn-info" role="button">LIRE LE BLOG</a>
             </div>
        </div>
