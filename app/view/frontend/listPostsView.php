...
<div class="container-fluid">
    ...
    <section class="blog-container">
        ...
        while ($data = $posts->fetch()) {
            ?>
            <div class="blog-card col-lg-12" style="background: url(images/pic<?= $data['id']?>.jpg) center no-repeat;">
                        ...
                        <div class="utility-info">
                            <ul class="utility-list">
                                <li><span class="licon icon-com"></span>
                                    <a href="chapters.php?action=post&amp;id=<?= $data['id'] ?>#comments"><?= $data['counter']
                                ?> Commentaires</a></li>
